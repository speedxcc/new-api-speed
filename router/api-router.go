...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		dataRoute.GET("/token-stats", middleware.AdminAuth(), controller.GetTokenUsageStats)
		dataRoute.GET("/token-stats/self", middleware.UserAuth(), controller.GetUserTokenUsageStats)
