...
func InitOptionMap() {
	...
	common.OptionMap["SubscriptionBalanceEnabled"] = strconv.FormatBool(common.SubscriptionBalanceEnabled)
	...
	common.OptionMap["GroupPassThrough"] = setting.GroupPassThrough2JsonString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "SubscriptionBalanceEnabled":
			common.SubscriptionBalanceEnabled = boolValue
		case "DrawingEnabled":
	...
	case "GroupPassThrough":
		err = setting.UpdateGroupPassThroughByJsonString(value)
